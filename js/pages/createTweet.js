...
export default function createTweet () {
  ...
  dom.innerHTML = `
  <div class='create-tweet-modal'>
    <link rel="stylesheet" href="../../css/composeTweet.min.css">
    <div class="heading">
  ...
  <div class='new-tweet'>
    <div class='user-image'>
      <img alt="Mahmoud" width="48px" height="48px" draggable="true"
    ...
    <div class='content'>
      ...
      <div class="controls">
        <ul>
          <li>
            <span class="icon color-primary image"><svg viewBox="0 0 24 24" aria-hidden="true">
                <g>
                  <path
          ...
          <li>
            <span class="icon color-primary gif"><svg viewBox="0 0 24 24" aria-hidden="true">
                <g>
                  <path
          ...
          <li>
            <span class="icon color-primary poll"><svg viewBox="0 0 24 24" aria-hidden="true">
                <g>
                  <path
          ...
          <li>
            <span class="icon color-primary emoji"><svg viewBox="0 0 24 24" aria-hidden="true">
                <g>
                  <path
          ...
          <li>
            <span class="icon color-primary schedule"><svg viewBox="0 0 24 24" aria-hidden="true"
